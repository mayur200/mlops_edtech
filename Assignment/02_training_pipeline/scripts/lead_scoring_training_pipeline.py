...
utils = module_from_file("utils", "/home/Assignment/02_training_pipeline/scripts/utils.py")
constants = module_from_file("utils", "/home/Assignment/02_training_pipeline/scripts/constants.py") 
